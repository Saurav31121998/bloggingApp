...
import com.application.blog.config.AppContants;
...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPost(
			...
			@RequestParam(value = "sortDir", defaultValue = AppContants.sortDir, required = false) String sortDir
			) {
	...
	public ResponseEntity<PostDto> uploadPostImage(
	    ...
	    // Set the image property in PostDto
	    postDto.setImage(fileName);	 

	    // Update the post with the modified PostDto
